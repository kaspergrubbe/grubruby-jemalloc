...
## [Unreleased]
### Changed
- Updated Rubygems to version `2.7.8`, which includes some minor enhancements and bug-fixes: http://blog.rubygems.org/2018/11/02/2.7.8-released.html.  [#4](https://github.com/kaspergrubbe/grubruby-jemalloc/pull/4)
